...
- **New city or language**: add one entry to `src/content/cities.ts` or `src/content/languages.ts`. All pages, nav, footer links, and the sitemap update automatically with generated default copy.
